...
%************************************************************************%
%% MOUSE OVER IN RANDOM FUNCTIONS
function GraphVar_mouseMovedCallback_Random(jListbox, jEventData, hListbox,JBox,handles)
...
msgStr = sprintf('<html>%s</html>', handles.randomFuncDescription{hoverIndex});
